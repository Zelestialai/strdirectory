...
import { LayoutDashboard, User, MessageSquare, Star, BarChart2, Zap, Users, Settings, CreditCard, Sparkles } from "lucide-react";
...
const navLinks = [
  ...
  { href: "/dashboard/jobs",       label: "Turnover Jobs", icon: Sparkles },
