-- ============================================================
-- Migration 007 — Markets table
-- A market groups multiple cities under one browsable destination
-- ============================================================
...
create table if not exists public.markets (
  ...
  state       text not null,       -- primary state abbreviation
  cities      text[] not null,     -- all cities included in this market
  tagline     text,
  description text,
...
create policy "Admins can manage markets"
  on public.markets for all using (
