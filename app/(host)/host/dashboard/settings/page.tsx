...
import {
  NotificationToggles,
  HOST_NOTIFICATION_ITEMS,
  type NotificationPrefs,
} from "@/components/settings/NotificationToggles";
...
export default async function HostSettingsPage() {
  ...
  if (!user) redirect("/login?next=/host/dashboard/settings");
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <NotificationToggles initial={prefs} items={HOST_NOTIFICATION_ITEMS} />
      <ChangePasswordForm />
      <DangerZone />
    </div>
  );
