...
import { LayoutDashboard, Users, Store, ShieldCheck, Building2, Star, MessageSquare, MapPin, Tag } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-900 text-white px-4 py-2 text-xs flex items-center justify-between">
        <span className="flex items-center gap-2 font-medium">
          <ShieldCheck className="h-3.5 w-3.5 text-amber-400" /> Admin Panel
        </span>
        <Link href="/" className="flex items-center gap-1 text-gray-400 hover:text-white transition">
          <Building2 className="h-3.5 w-3.5" /> Back to Site
        </Link>
      </div>
